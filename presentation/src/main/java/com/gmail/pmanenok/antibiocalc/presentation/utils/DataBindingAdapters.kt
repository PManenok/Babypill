...
fun setText(view: TextView, stringId: Int, drugType: Int) {
    val array: Array<String> = when (drugType) {
        ...
        MenuType.ANTICOUGH.getId() -> view.resources.getStringArray(R.array.anticoughs)
        else -> emptyArray()
    }
...
fun setText(
    ...
    val substance: String =
        view.resources.getStringArray(R.array.suspension_type)[substanceType.getId()]
    val substanceMassUnit: String =
        view.resources.getStringArray(R.array.suspension_mass_unit)[substanceType.getId()]
    val template: String =
    ...
    view.text =
        template.format(substance, concentration, concentrationIn, substanceMassUnit, result, times)
}
